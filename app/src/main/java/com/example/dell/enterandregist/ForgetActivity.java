...
public class ForgetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_foget);
        init();  //初始化控件
    }
     ...
     * */
    private void init() {
        editTextP = (EditText) findViewById(R.id.et_phone);
        editSMS = (EditText) findViewById(R.id.et_sms);
        editTextCT = (EditText) findViewById(R.id.et_password);
        button = (Button) findViewById(R.id.bn_submit);
        ...
        SMSBtn = (Button) findViewById(R.id.bn_sms);
